<script type="text/javascript">
	...
	{
		$('#offline_saja input[type=radio]').prop('checked', false);
		if (jenis_server == 3)
		{
			$('#offline_saja').hide();
				...
				<div class="box box-info">
					<form id="validasi" action="<?= $form_action?>" method="POST" target="_blank" class="form-surat form-horizontal">
						<div class="box-body">
							...
							<div class="form-group" >
								...
								<div class="col-sm-9 col-lg-4">
									<select class="form-control required input-sm" name="jenis_server" onchange="ubah_jenis_server($(this).val())">
										...
										<option value="3" <?php selected($this->setting->penggunaan_server, '3')?>>
							...
							<div class="form-group" id="offline_online_hosting" style="display: none;">
								<label class="col-sm-3 control-label">Server ini digunakan sebagai</label>
								<div class="col-sm-9 col-lg-4">
									<select class="form-control required input-sm" name="server_mana" onchange="ubah_server($(this).val())">
							...
							<div class="form-group" id="offline_ada_hosting" style="display: none;">
								<label class="col-sm-3 control-label">Akses web pada server offline ini</label>
								<div class="col-sm-6 col-lg-4">
									<select class="form-control required input-sm" name="offline_mode">
										<option value='' selected="selected">-- Pilih Akses Web --</option>
										<option value="3" <?php selected($this->setting->offline_mode, '3')?>>
											Web bisa diakses petugas web
										</option>
										<option value="4" <?php selected($this->setting->offline_mode, '4')?>>
											Web non-aktif sama sekali
										</option>
									</select>
								</div>
							</div>
							<div class="form-group" id="offline_saja" style="display: none;">
								<label class="col-sm-3 control-label">Akses web pada server offline ini</label>
								<div class="col-sm-6 col-lg-4">
									<select class="form-control required input-sm" name="offline_mode">
										<option value='' selected="selected">-- Pilih Akses Web --</option>
