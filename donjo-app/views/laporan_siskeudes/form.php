<div class="content-wrapper">
	<section class="content-header">
		<h1>Pengaturan Laporan Siskeudes</h1>
		<ol class="breadcrumb">
			<li><a href="<?= site_url('hom_sid')?>"><i class="fa fa-home"></i> Home</a></li>
			<li><a href="<?= site_url().$this->controller.'/index/'.$kat?>"><i class="fa fa-dashboard"></i> Daftar Laporan Siskeudes</a></li>
			<li class="active">Pengaturan Laporan Siskeudes</li>
		</ol>
	</section>
		...
		<form id="validasi" action="<?= $form_action?>" method="POST" enctype="multipart/form-data" class="form-horizontal">
            ...
            <div class="box-header with-border">
							<a href="<?= site_url().$this->controller.'/index/'.$kat?>" class="btn btn-social btn-flat btn-info btn-sm btn-sm visible-xs-block visible-sm-inline-block visible-md-inline-block visible-lg-inline-block"  title="Tambah Artikel">
								<i class="fa fa-arrow-circle-left "></i>Kembali Ke Daftar Laporan Siskeudes
            	</a>
						</div>
						<div class="box-body">
							...
							<input name="kategori" type="hidden" value="4">
							<?php
								if ($kat == 2)
