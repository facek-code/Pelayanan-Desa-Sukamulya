...
<div class="content-wrapper">
	<section class="content-header">
		...
		<ol class="breadcrumb">
			...
			<li class="active">Laporan Siskeudes</li>
		</ol>
	</section>
						...
						<div class="box-body">
							<div class="row">
								<div class="col-sm-12">
                                  ...
                                  <?php endif; ?>
																	<th nowrap>Tahun Anggaran</th>
																	<th nowrap>Tahap</th>
																	<th>Dikirim Ke OpenDK Pada</th>
                                  <?php if ($o==4): ?>
                                  ...
                                  <?php endif; ?>
                                      ...
                                      <?php endif ?>
																			...
																			<a href="<?= site_url("{$this->controller}/kirim/$p/$o/$data[id]")?>" class="btn bg-teal btn-flat btn-sm"  title="Kirim ke OpenDK"><i class="fa fa-share"></i></a>
																		...
																		<td><?= $data['nama']?></td>
																		<?php $tahun = array('2019', '2018');?>
																		<td><?= $tahun[array_rand($tahun)]?></td>
																		<td><?= rand(1, 3)?></td>
																		<?php $t = tgl_indo2(date('Y-m-d H:i:s', strtotime("+35 hours", strtotime($data['tgl_upload'])))) ?>
																		<td><?= rand(0, 2) ? $t : ''?></td>
																		<td><?= $data['aktif']?></td>
